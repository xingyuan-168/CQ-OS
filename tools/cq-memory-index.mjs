...
const walk = async (dir) => {
  ...
  for (const entry of entries) {
    if (entry.name === 'index.json' || entry.name === 'schema' || entry.name === 'validation' || entry.name === 'selfcheck' || entry.name === 'review' || entry.name === 'policy' || entry.name.endsWith('.README.md')) continue
